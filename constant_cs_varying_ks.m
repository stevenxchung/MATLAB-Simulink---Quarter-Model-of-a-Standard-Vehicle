%% LVD Project Body Model Initialization (constant_cs_varying_ks.m)
...
%}
    ...
    cs = 1650;                  % Suspension oil damping [N*s/m] (500-3000) 

    kp = 45005;                 % Thorax and Pelvis stiffness [N/m] (2000-50000)
    kc = 20000;                 % Seat cushion stiffness [N/m] (2000-50000)
    %ks = 10000;                % Suspension spring stiffness [N/m] (2500-25000, Default @ 10000)
    ...
    wh_d_vector = zeros(5,1);
    wb_d_vector = zeros(5,1);
    ws_d_vector = zeros(5,1);
    wu_d_vector = zeros(5,1);
    ...
    while (ks < 25000)
        ...
        legend('k1 = 5000 [N/m]', 'k2 = 10000 [N/m]', 'k3 = 15000 [N/m]', 'k4 = 20000 [N/m]', 'k5 = 25000 [N/m]', 'Location', 'best');
        grid on
        hold on
        ...
        %{
        % Case: b = 1 [m] (Includes Sine Input Signal)
